...
define([], function() {
  ...
  var Router = Backbone.Router.extend({
    ...
    study: function() {
      var self = this;
      require(['views/study'], function(View) {
        self.render(View);
      });
    },
    talk: function(examId) {
      var self = this;
      require(['views/talk'], function(View) {
        self.render(View, {
          examId: examId
        });
      });
    ...
    monitor: function() {
      var self = this;
      require(['views/monitor'], function(View) {
        self.render(View);
      });
    },
    vision: function(examId) {
      var self = this;
      require(['views/vision'], function(View) {
        self.render(View, {
          examId: examId
        });
      });
    ...
    admin: function(examId) {
      var self = this;
      require(['views/admin/main'], function(View) {
        self.render(View, {
          examId: examId
        });
      });
