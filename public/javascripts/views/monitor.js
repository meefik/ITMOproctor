...
define([
  ...
  var View = Backbone.View.extend({
    ...
    destroy: function() {
      this.timers.forEach(function(element) {
    ...
    formatStatus: function(val, row) {
      ...
      case 0:
        return (
          '<span style="color:olive;">' + i18n.t('exam.status.0') + '</span>'
        );
      case 1:
        return (
          '<span style="color:teal;">' + i18n.t('exam.status.1') + '</span>'
        );
      case 2:
        return (
          '<span style="color:orange;">' + i18n.t('exam.status.2') + '</span>'
        );
      case 3:
        return (
          '<span style="color:red;">' + i18n.t('exam.status.3') + '</span>'
        );
      case 4:
        return (
          '<span style="color:green;">' + i18n.t('exam.status.4') + '</span>'
        );
      case 5:
        return (
          '<span style="color:purple;">' + i18n.t('exam.status.5') + '</span>'
        );
      case 6:
        return (
          '<span style="color:gray;">' + i18n.t('exam.status.6') + '</span>'
        );
      default:
        return null;
      }
